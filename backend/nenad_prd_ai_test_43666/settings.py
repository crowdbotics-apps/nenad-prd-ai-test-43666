"""
Django settings for nenad_prd_ai_test_43666 project.
...
ROOT_URLCONF = 'nenad_prd_ai_test_43666.urls'
...
WSGI_APPLICATION = 'nenad_prd_ai_test_43666.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nenad_prd_ai_test_43666 API",
    "DESCRIPTION": "API documentation for nenad_prd_ai_test_43666 App",
    "VERSION": "v1",
}
